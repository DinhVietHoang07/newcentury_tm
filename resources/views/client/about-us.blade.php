...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="video-text set-bg" data-setbg="{{asset('client/img/video-bg.jpg">
    ...
    <section class="testimonial-section set-bg spad" data-setbg="{{asset('client/img/testimonial-bg.jpg')}}">
       <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
