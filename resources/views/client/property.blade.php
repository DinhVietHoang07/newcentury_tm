                    ...
                    <div class="property-list">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="property-text">
                                        ...
                                        <h5 class="r-title"><a href="/property-details" style="color:black"> Villa 9721 Glen Creek</a></h5>
                        ...
                        <div class="single-property-item">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="property-pic">
                                        <img src="{{asset('client/img/properties/property-2.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="property-text">
                        ...
                        <div class="single-property-item">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="property-pic">
                                        <img src="{{asset('client/img/properties/property-3.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="property-text">
                        ...
                        <div class="single-property-item">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="property-pic">
                                        <img src="{{asset('client/img/properties/property-4.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="property-text">
